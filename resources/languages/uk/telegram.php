...
*Виконано сьогодні: %d*
*Не зроблено сьогодні: %d*

/завтра - заплануйте завдання на завтра.
/future - організуйте свої завдання на майбутні дати.
EOF;
        ...
        'errors' => [
            'invalid' => [
                'title' => [
                    ...
                    'characters' => "||(QID: 6)||\n 🚫 Помилка: Назва завдання не може містити спеціальних символів, таких як підкреслення або зірочки."
                ],
                'date-format' => "||(QID: 4)||\n 🚫 Помилка: Неправильний формат дати. Будь ласка, використовуйте формат ДД.ММ (наприклад, 12.01 для 12 січня).",
                'date-in-past-or-invalid' => "||(QID: 5)||\n 🚫 Помилка: Дата є або недійсною, або в минулому. Будь ласка, введіть дійсну майбутню дату протягом цього року. " . date(
                        'Y'
                    ),
            ],
            'business' => [
