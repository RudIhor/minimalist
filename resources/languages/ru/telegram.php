...
$helpCommandText = <<<EOF
Добро пожаловать в Minimalist! Ваш простой и лаконичный менеджер задач в Telegram. Вот список команд, которые помогут вам получить максимум от этого опыта:
...
return [
    'commands' => [
        ...
        'specify-task-number' => '🔢 Пожалуйста, укажите номер задачи, которую вы хотите %s.',
        'no-tasks' => '📅 На эту дату нет запланированных задач.',
    ],
    'validation' => [
        'errors' => [
            'invalid' => [
